      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* <a href="https://drive.google.com/file/d/1pu1k7HA7pMOq_su_1IvI7XquFbh2JFhE/view?usp=sharing">
            ...
            >
              <button
                type="button"
                className="cursor-pointer flex items-center gap-2.5 border border-gray-500/30 px-6 py-3 text-sm text-gray-800 rounded bg-white hover:text-blue-400 hover:bg-blue-400/10 hover:border-blue-400/30 active:scale-95 transition"
              >
                <svg
                  width="16"
                  height="16"
